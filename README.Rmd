...
This leads to the table \@ref(tab:table-overlap) wich can be downloaded as an rds [here](https://github.com/Sustainscapes/BiodiversityCounsil/blob/master/Area_summary.rds), or as a csv [here](https://github.com/Sustainscapes/BiodiversityCounsil/blob/master/Area_summary.csv) 
...
This generates a summarized table shown in table \@ref(tab:table-overlap-summarized), this can be downloaded as an rds [here](https://github.com/Sustainscapes/BiodiversityCounsil/blob/master/Table1.rds), or a csv [here](https://github.com/Sustainscapes/BiodiversityCounsil/blob/master/Table1.csv)
...
The results of this code are seen in table \@ref(tab:show-second-table), and the table can be downloaded as an rds [here](https://github.com/Sustainscapes/BiodiversityCounsil/blob/master/Total.rds) or as a csv [here](https://github.com/Sustainscapes/BiodiversityCounsil/blob/master/Table1.csv)
...
This was already rasterized above, so we only need to mask it to sea and save it
...
<details style=\"margin-bottom:10px;\">
<summary>Nature and wildlife reservations</summary>
```{r NaturaOgVildtreservater-sea-raster}

```
</details>

the results can be seen in figure \@ref(fig:PlotNaturaOgVildtreservaterSea)

```{r PlotNaturaOgVildtreservaterSea, fig.cap= "Plot of the areas of Natura 2000 within the sea of Denmark", echo=FALSE, cache=TRUE}
